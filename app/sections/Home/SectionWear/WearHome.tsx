        ...
        <section className='WearHomeContainer'>
            ...
            <div className='WearHomeWrapper'>
                <div className='WearImg img1'>
                    <img className='img1-1' src={imgWearComplements} alt="Imagen complementos olga lucia cortes" loading={isMobile ? 'eager' : 'lazy'} decoding={isMobile ? 'auto' : 'async'} width={780} height={1200} />
