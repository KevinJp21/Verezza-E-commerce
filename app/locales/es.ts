export default {
    ...
    "TermsofUse": {
        ...
        "refundPolicy": {
            ...
            "li2P7": "En caso de que no seas el titular del medio de pago con el que se hizo la compra, recuerda que quien debe presentar la solicitud directamente a SOLO BLANCO – OLGA LUCIA CORTES, es el titular.",
            ...
            "li2P9": "El consumidor deberá devolver el producto a SOLO BLANCO – OLGA LUCIA CORTES en las mismas condiciones en que lo recibió.",
            ...
            "li2P11": "En caso de que sea realizada la reversión del pago por parte del emisor del instrumento de pago y SOLO BLANCO – OLGA LUCIA CORTES haya también realizado directamente la devolución del precio pagado, el comprador deberá devolver los recursos directamente a SOLO BLANCO – OLGA LUCIA CORTES",
        ...
        "termsAndConditions": {
            ...
            "li1P1": "Pedidos nacionales (Colombia): El envío de los productos se realizará por medio de Servientrega S.A., un operador logístico externo y contratado por SOLO BLANCO – OLGA LUCIA CORTES.",
