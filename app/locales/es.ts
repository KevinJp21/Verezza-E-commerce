export default {
    ...
    "TermsofUse": {
        "seo": {
            ...
            "descripcion": "Conoce las Condiciones de Uso del sitio web de SOLO BLANCO – VEREZZA. Al acceder y navegar por nuestro sitio, aceptas cumplir con estos términos que regulan el uso del sitio y las compras realizadas."
        },
        "privacyPolicy": {
        ...
        "refundPolicy": {
            ...
            "p1": "<strong>CAMBIOS DIFERENTES A GARANTÍAS</strong>: Contamos con una política comercial de cambios -diferente a las garantías- en virtud de la cual aceptamos por cada compra un solo cambio, estas solicitudes y las reclamaciones relacionadas con éstos se aceptan hasta diez (10) días después de la fecha de entrega. En este plazo usted debe hacer llegar su solicitud de cambio al correo electrónico <strong><a href='mailto:servicioalclienteolgacortes@gmail.com'>servicioalclienteolgacortes@gmail.com</a></strong> o enviando un mensaje de WhatsApp al número <strong>+57 3215385233</strong>, para estos cambios es necesaria la presentación de la factura de venta original, los productos deben estar en perfecto estado, con las etiquetas y empaques originales y no deben tener ningún signo de haber sido utilizados. SOLO BLANCO – VEREZZA responderá su solicitud en un plazo no máximo a 15 días hábiles, nuestro equipo de soporte le indicará los pasos a seguir para la devolución del paquete, los gastos de envío deben ser asumidos por el cliente, SOLO BLANCO – VEREZZA, no se hace responsable por la pérdida de los paquetes con artículos en devolución, en caso de aceptarse el cambio se ofrecerá cambio por talla, cambio por otro artículo o un saldo a favor del cliente para realizar una nueva compra a través de olgaluciacortes.com, pero no habrá lugar a devolución de dinero. A las compras de artículos en promoción solo se les ofrecerá cambio por talla, en caso de no haber existencias, se dará un saldo a favor. *el cliente es el encargado de costo del envío de regreso y está sujeto a disponibilidad.",
            ...
            "li2P5": "Debe ser una compra realizada a través de <strong><a href='https://olgaluciacortes.com'>olgaluciacortes.com</a></strong>.",
            ...
            "li2P7": "En caso de que no seas el titular del medio de pago con el que se hizo la compra, recuerda que quien debe presentar la solicitud directamente a SOLO BLANCO – VEREZZA, es el titular.",
            "li2P8": "Al presentar la solicitud deberá indicar el lugar en que fue recibido el bien para efectos de su recogida o si lo prefiere, enviarlo hasta las instalaciones de SOLO BLANCO en este caso, luego de presentar la reclamación, nuestros asesores le indicarán a donde debe hacer llegar el paquete ya que ello varía de acuerdo al lugar donde usted se encuentre.",
            "li2P9": "El consumidor deberá devolver el producto a SOLO BLANCO – VEREZZA en las mismas condiciones en que lo recibió.",
            ...
            "li2P11": "En caso de que sea realizada la reversión del pago por parte del emisor del instrumento de pago y SOLO BLANCO – VEREZZA haya también realizado directamente la devolución del precio pagado, el comprador deberá devolver los recursos directamente a SOLO BLANCO – VEREZZA",
        ...
        "termsAndConditions": {
            ...
            "p2": "En SOLO BLANCO – VEREZZA, queremos garantizar que tu pedido sea entregado en el tiempo acordado.",
            ...
            "li1P1": "Pedidos nacionales (Colombia): El envío de los productos se realizará por medio de Servientrega S.A., un operador logístico externo y contratado por SOLO BLANCO – VEREZZA.",
            ...
            "li1P2": "Pedidos internacionales (fuera de Colombia): El envío de los productos se realizará por medio de DHL, un operador logístico externo y contratado por SOLO BLANCO – VEREZZA.",
            ...
            "p19": "SOLO BLANCO – VEREZZA realizará esfuerzos razonables para mantener actualizada la información de precios publicada en el sitio web.",
            "p20": "Le recomendamos que visite nuestro sitio web periódicamente para obtener información sobre los precios actuales.",
            "p21": "SOLO BLANCO – VEREZZA puede hacer ofertas promocionales con diferentes características, dinámicas y precios sin que estos sean aplicables para todos los compradores, en todo caso en la publicación de tales ofertas estarán publicadas las condiciones de tiempo, modo y lugar para poder acceder a ellas."
        ...
        "paymentAndCollections": {
            ...
            "p3": "SOLO BLANCO – VEREZZA no almacena información financiera de los clientes.",
            ...
            "li1-2P1": "Los pagos serán procesados a través de y Payu, un servicio externo contratado por SOLO BLANCO – VEREZZA que cuenta con la infraestructura tecnológica necesaria y certificación PCI DSS para que la información del pago se mantenga segura.",
            ...
            "li2P4": "Eximo a SOLO BLANCO – VEREZZA de toda responsabilidad por la información errónea, falsa, inexacta que se hubiese suministrado en este documento o por la violación del mismo, de tal suerte que seré el único responsable por ello."
        },
        "restrictions":{
            ...
            "p2": "Se le permite usar el contenido solo como lo autoriza expresamente SOLO BLANCO – VEREZZA."
        }
    },
    "returnsRefunds":{
        "seo": {
    ...
    "ourBrand":{  
        ...
        "p2": "En Verezza conocemos muy bien este concepto y por eso a través de nuestras creaciones exploramos y explotamos con delicadeza cada uno de estos detalles.",
